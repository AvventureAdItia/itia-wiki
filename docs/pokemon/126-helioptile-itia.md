<div style="text-align: center; margin-bottom: 20px;">
  ⬅️ <a href="https://avventureaditia.github.io/itia-wiki/pokemon/125-wishwashi-itia/"> 125 - Wishwashi <img src="../../img/icon/wishwashi-itia.png" style="vertical-align: middle;"></a>
  <strong>126 - Helioptile di Itia</strong> 
  <img src="../../img/icon/helioptile-itia.png" style="vertical-align: middle;">
  <a href="https://avventureaditia.github.io/itia-wiki/pokemon/127-heliolisk-itia/"> 127 - Heliolisk di Itia <img src="../../img/icon/heliolisk-itia.png" style="vertical-align: middle;"></a> ➡️
</div>
...
=== "Tassonomia"
    <p><div class="pokemon-attribute-container">
      <img src="../../img/pokemon/helioptile-itia.png" width="150" style="object-fit: contain;"/>
    ...
    <p><div class="pokemon-attribute-container">
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
            <p style="margin: 0; font-size: 14px; color: #737373;">6,00 kg</p>
          </div>
        </div>
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div style="display: flex; gap: 1rem;">
          <div class="pokemon-attribute" style="flex: 1;">
            ...
            <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
              <p style="margin: 0; font-size: 14px; color:Red;">58</p>
            </div>
          </div>
          <div class="pokemon-attribute" style="flex: 1;">
