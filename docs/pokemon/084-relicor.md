...
=== "Tassonomia"
    <p><div class="pokemon-attribute-container">
      <img src="../../img/pokemon/relicor.png" width="150" style="object-fit: contain;"/>
    ...
    <p><div class="pokemon-attribute-container">
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
            <p style="margin: 0; font-size: 14px; color: #737373;">54,16 kg</p>
          </div>
        </div>
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div style="display: flex; gap: 1rem;">
          ...
          <div class="pokemon-attribute" style="flex: 1;">
            ...
            <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
              <p style="margin: 0; font-size: 14px;">1 - HP / 2 - Attack</p>
            </div>
          </div>
        </div>
      </div>
...
=== "Descrizione Pokedex"
    ...
    Leggende narrano che quando un Gravient si trovi sulla strada percorsa da una schiera di Dracalier, il cuore scolpito sul petto ritorni a battere facendole evolvere in un Relicor. <br />
    Si dice che sia lo spirito di un vecchio generale che anche da spettro ritorni torni a comandare il proprio plotone con un'espressione cupa in volto. <br />
    A significare il suo tormento a ricordo di una disfatta passata che lo portò alla morte. <br />
