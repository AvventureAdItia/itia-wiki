...
=== "Tassonomia"
    <p><div class="pokemon-attribute-container">
      <img src="../../img/pokemon/cryptidile.png" width="200" style="object-fit: contain;"/>
      <div style="display: grid; grid-template-rows: 1fr 1fr 1fr 1fr; row-gap: 0.5rem;">
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9;">
            <p style="margin: 0px; font-weight: normal; font-size:16px; align-self: center;">Sfuggente</p>
          </div>
        </div>
        <div class="pokemon-attribute">
        ...
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f3f3f3;">
            <audio controls>
              <source src="../../audio/cryptidile.mp3" type="audio/mpeg">
            </audio>
          </div>
        </div>
      </div>
    ...
    <p><div class="pokemon-attribute-container">
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
            <p style="margin: 0; font-size: 14px; color: #737373;">31,87 kg</p>
          </div>
        </div>
...
=== "Descrizione Pokedex"
    ...
    Fin dalla loro nascita i Cryptidile sono ricoperti da fango e piante acquatiche perché le loro uova vengono deposte sotto terra. <br />
    Sono molto schivi e non amano il contatto con gli esseri umani e Pokémon per via della loro paura nel guardarli. <br />
...
=== "Shiny"
    <div style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 20px;">
      <div style="flex: 1; text-align: center;">
        <img src="../../img/back_shiny/CRYPTIDILE.png" width="100" style="object-fit: contain;"/>
      </div>
      <div style="flex: 1; text-align: center;">
        <img src="../../img/front_shiny/CRYPTIDILE.png" width="100" style="object-fit: contain;"/>
      </div>
    </div>
...
| Method | Item/Level/Note | Evolved Pokemon |
        | :--: | :--: | :--: |
        | Level Up | 18 | [Elusuchus](https://avventureaditia.github.io/itia-wiki/pokemon/049-elusuchus/) |
