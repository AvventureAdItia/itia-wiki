<div style="text-align: center; margin-bottom: 20px;">
  ⬅️ <a href="https://avventureaditia.github.io/itia-wiki/pokemon/114-shrimitzer/"> 114 - Shrimitzer <img src="../../img/icon/shrimitzer.png" style="vertical-align: middle;"></a>
  <strong>115 - Elgyem di Itia</strong> 
  <img src="../../img/icon/elgyem-itia.png" style="vertical-align: middle;">
  <a href="https://avventureaditia.github.io/itia-wiki/pokemon/116-beheeyem-itia/"> 116 - Beheeyem di Itia <img src="../../img/icon/beheeyem-itia.png" style="vertical-align: middle;"></a> ➡️
</div>
...
=== "Tassonomia"
    <p><div class="pokemon-attribute-container">
      <img src="../../img/pokemon/elgyem-itia.png" width="150" style="object-fit: contain;"/>
    ...
    <p><div class="pokemon-attribute-container">
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
            <p style="margin: 0; font-size: 14px; color: #737373;">12,32 kg</p>
          </div>
        </div>
      ...
      <div style="display: grid; grid-template-rows: 1fr 1fr; row-gap: 0.5rem;">
        ...
        <div style="display: flex; gap: 1rem;">
          <div class="pokemon-attribute" style="flex: 1;">
            ...
            <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
              <p style="margin: 0; font-size: 14px; color: #737373;">Human-Like</p>
            </div>
          </div>
          <div class="pokemon-attribute" style="flex: 1;">
        ...
        <div style="display: flex; gap: 1rem;">
          <div class="pokemon-attribute" style="flex: 1;">
            ...
            <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9; text-align: center;">
              <p style="margin: 0; font-size: 14px; color:Red;">67</p>
            </div>
          </div>
          <div class="pokemon-attribute" style="flex: 1;">
...
=== "Descrizione Pokedex"
    ...
    Questi Pokémon sono i principali lavoratori della loro specie. <br />
    Sono incaricati di scavare grandi sistemi di tunnel e caverne che amplieranno notevolmente il nido costruito all'interno di grandi montagne, dove spesso entrano in conflitto con il Larvitar. <br />
    Tutta la linea evolutiva è in grado di comunicare scrivendo messaggi sulla propria fronte. <br />
    Gli Elgyem, in particolare, hanno meno spazio su cui scrivere e perciò conoscono i vocaboli più essenziali e semplici per comunicare. <br />
...
=== "Base"
    <div style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 20px;">
      <div style="flex: 1; text-align: center;">
        <img src="../../img/back/ELGYEM_1.png" width="100" style="object-fit: contain;"/>
      </div>
      <div style="flex: 1; text-align: center;">
        <img src="../../img/front/ELGYEM_1.png" width="100" style="object-fit: contain;"/>
      </div>
    </div>
...
=== "Shiny"
    <div style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 20px;">
      <div style="flex: 1; text-align: center;">
        <img src="../../img/back_shiny/ELGYEM_1.png" width="100" style="object-fit: contain;"/>
      </div>
      <div style="flex: 1; text-align: center;">
        <img src="../../img/front_shiny/ELGYEM_1.png" width="100" style="object-fit: contain;"/>
      </div>
    </div>
