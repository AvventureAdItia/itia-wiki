  ...
  <div style="display: grid; grid-template-rows: 1fr 1fr 1fr; row-gap: 0.5rem;">
    ...
    <div class="pokemon-attribute">
      ...
      <div class="attribute-value">
        ...
        /<a href='' title="Se il Pokémon viene colpito da una mossa fisica questo si carica e il suo attacco speciale viene aumentato. Ha un solo utilizzo che viene recuperato lasciando il campo di battaglia.">Leva-di-sgancio</a>
      </div>
    </div>
