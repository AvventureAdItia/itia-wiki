...
=== "Tassonomia"
    <p><div class="pokemon-attribute-container">
      <img src="../../img/pokemon/stakiles.png" width="200" style="object-fit: contain;"/>
      <div style="display: grid; grid-template-rows: 1fr 1fr 1fr 1fr; row-gap: 0.5rem;">
        <div class="pokemon-attribute">
          ...
          <div class="attribute-value" style="border: 1px solid #ccc; padding: 5px; border-radius: 5px; background-color: #f9f9f9;">
            <p style="margin: 0px; font-weight: normal; font-size:16px; align-self: center;">Barilfiamma</p>
          </div>
        </div>
        <div class="pokemon-attribute">
...
=== "Descrizione Pokedex"
    ...
    Gli Stakiles vagano di notte in cerca di cibo e se non lo trovano per ripicca appicano dei piccoli incendi. <br />
    Sembrano essere stati la causa di un grande incendio nell'antichità di Itia, che ancora oggi viene chiamato "La notte dei 100 Stakiles". <br />
    Usano il barile come protezione e nessuno sa cosa si nasconde al loro interno. <br />
...
=== "Base"
    <div style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 20px;">
      <div style="flex: 1; text-align: center;">
        <img src="../../img/back/STAKILES.png" width="100" style="object-fit: contain;"/>
      </div>
      <div style="flex: 1; text-align: center;">
        <img src="../../img/front/STAKILES.png" width="100" style="object-fit: contain;"/>
      </div>
    </div>
...
=== "Shiny"
    <div style="display: flex; justify-content: space-around; align-items: center; margin-bottom: 20px;">
      <div style="flex: 1; text-align: center;">
        <img src="../../img/back_shiny/STAKILES.png" width="100" style="object-fit: contain;"/>
      </div>
      <div style="flex: 1; text-align: center;">
        <img src="../../img/front_shiny/STAKILES.png" width="100" style="object-fit: contain;"/>
      </div>
    </div>
